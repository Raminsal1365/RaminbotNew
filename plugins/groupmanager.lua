...
elseif lang then
return "☆🔚لینک در گروه از قبل ممنوع نیست\n➖➖➖➖➖➖➖\nتوسط ☆>*[*@"..check_markdown(msg.from.username or "").."*]*"
end
else 
...
if matches[1] == "help" and is_mod(msg) or  matches[1] == "کمک" and is_mod(msg) then
text = [[
🔖*IDBOT*: @raminsalofficial
🤖*💫Ramin™©*
*___________________________*
...
✅پاک کردن یوزرنیم
بفرس👈🏿 :*قفل یوزرنیم*
بفرس👈🏿 :*بازکردن یوزرنیم*
➖〰➖〰➖〰➖〰➖〰➖〰➖
✅پاک کردن فراخوانی
بفرس👈🏿 :*قفل فراخوانی*
بفرس👈🏿 :*بازکردن فراخوانی*
➖〰➖〰➖〰➖〰➖〰➖〰➖
✅پاک کردن نوشتن به انگلیسی
بفرس👈🏿 :*قفل انگلیسی*
بفرس👈🏿 :*بازکردن انگلیسی*
➖〰➖〰➖〰➖〰➖〰➖〰➖
✅پاک کردن نوشتن فارسی
بفرس👈🏿 :*قفل عربی*
بفرس👈🏿 :*بازکردن عربی*
...
➖〰➖〰➖〰➖〰➖〰➖〰➖
✅پاک کردن خدمات تلگرام
بفرس👈🏿: *بیصدا سرویس تلگرام*
بفرس👈🏿 :*باصدا سرویس تلگرام*
➖〰➖〰➖〰➖〰➖〰➖〰➖
✅پاک کردن دکمه شیشه ای
بفرس👈🏿 :*بیصدا دکمه شیشه ای*
بفرس👈🏿 :*باصدا دکمه شیششه ای*
➖〰➖〰➖〰➖〰➖〰➖〰➖
✅پاک کردن بازی تحت وب
بفرس👈🏿 :*بیصدا بازی*
بفرس👈🏿 :*باصدا بازی*
...
1️⃣تنظیم شخص به عنوان مدیر گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!remowner* `[username|id|reply]`
2️⃣تنزل مقام شخص از معاون گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!promote* `[username|id|reply]`
3️⃣تنظیم شخص به عنوان معاون گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!demote* `[username|id|reply]`
4️⃣تنزل مقام شخص از معاون گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!setflood* `[1-50]`
5️⃣تنظیم حساسیت پیام مکرر
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!silent* `[username|id|reply]`
6️⃣ساکت کردن فرد
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!unsiletnt* `[username|id|reply]`
7️⃣ازاد شدن فرد از حالت سایلنت
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!kick* `[username|id|reply]`
8️⃣اخراج فرد از گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!ban* `[username|id|reply]`
9️⃣مسدود کردن فرد از گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!unban* `[username|id|reply]`
🔟ازاد کردن فرد از گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!res* `[username]`
1️⃣1️⃣نمایش اطلاعات یوزرنیم
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!whois* `[id]`
2️⃣1️⃣نمایش اطلاعات ایدی
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!config*
3️⃣1️⃣معاون کردن تمام ادمین ها
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!set*`[rules | name | photo | link | about | welcome]`
4️⃣1️⃣تنظیم به ترتیب [قوانین ، نام ، عکس ، لینک ، درباره ، پیام خوش امد گویی] برای گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!clean* `[bans | mods | bots | rules | about | silentlist | filtelist | welcome]`
5️⃣1️⃣پاک کردن به ترتیب [مسدود ها ، معاون ها ، ربات ها ، قوانین ، درباره گروه ، ساکت ها ، فیلتر ها ، پیام خوش امد گویی ]
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!filter* `[word]`
6️⃣1️⃣فیلتر کلمه مورد نظر 
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!unfilter* `[word]`
7️⃣1️⃣پاک شدن کلمه از لیست فیلتر
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!pin* `[reply]`
8️⃣1️⃣سنجاق پیام مورد نظر
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!unpin*
9️⃣1️⃣غیر فعال کردن سنجاق
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!welcome* `[on-off]`
1️⃣2️⃣فعال کردن و غیر فعال کردن پیام خوش امد گویی
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!settings*
2️⃣2️⃣نمایش تنظیمات گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!silentlist*
3️⃣2️⃣نمایش لیست افراد ساکت
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!filterlist*
4️⃣2️⃣نمایش لیست کلمات فیلتر
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!banlist*
5️⃣2️⃣نمایش لیست افراد مسدود شده
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!ownerlist*
6️⃣2️⃣نمایش لیست مدیران
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!modlist*
7️⃣2️⃣نمایش لیست معاون ها
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!rules*
8️⃣2️⃣نمایش قوانین گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!about*
9️⃣2️⃣نمایش درباره گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!gpinfo*
0️⃣3️⃣نمایش اطلاعات گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!newlink*
1️⃣3️⃣ساخت لینک جدید
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!link*
2️⃣3️⃣دریافت لینک گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!delall* `[username|id|reply]`
3️⃣3️⃣پاک کردن تمام پیام های فرد
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!setwelcome* `[text]`
4️⃣3️⃣تنظیم پیام خوش امد گویی
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!rmsg* `[number]`
5️⃣3️⃣پاک کردن تعداد پیام اخیر سوپر گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!addban*
6️⃣3️⃣اضافه کردن افرادی که در لیست مسدود های گروه هستن به گروه
➖〰➖〰➖〰➖〰➖〰➖〰➖
*!clean deleted*
7️⃣3️⃣پاک کردن دلیت اکنتی ها از گروه
*___________________________*
8️⃣3️⃣هرگاه در جلوی دستوری این نوشته
`[username|id|reply]`
...
if matches[1] == "نرخ" or matches[1] == "nerkh" and is_sudo(msg) then
text = [[
...
💰💰💰💰💰💰💰
1⃣.توجه داشته باشید به هیچ وجه نباید ربات رو از گروه حذف کنید و در صورت داشتن هرگونه مشکل فقط اون رو از ادمینی گروه بردارید و به بنده مراجعه کنید.
2⃣.لازم به ذکره اولویت بصورت پرداخت کارت به کارت میباشد.
3⃣.ربات دائمی داریم باکیفیت و کارای بالای ربات.
________________
برای خرید به ایدی زیر مراجعه کنید :
🆔: 🔖*IDBOT*: @raminsalofficial
🤖*💫Ramin™©*
و اگر ریپورت هستید به :
🆔: https://t.me/joinchat/FDOtykIJLMLOhkQU5bWkzw
]]
return text
end
if matches[1] == "پشتیبانی" or matches[1] == "support" and is_sudo(msg) then
text = [[
♥️☠️✖️Gebruiker verwijderd✖️☠️♥️,
پشتیبانی https://t.me/joinchat/FDOtykIJLMLOhkQU5bWkzw
